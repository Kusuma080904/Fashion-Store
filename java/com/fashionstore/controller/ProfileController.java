...
public class ProfileController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        com.fashionstore.service.AddressService addressService = new com.fashionstore.service.AddressService();
        com.fashionstore.model.Address defaultAddress = addressService.getDefaultAddress(user.getId());
