...
<%@ page import="com.fashionstore.service.ProductService" %>
<%@ page import="com.fashionstore.util.SessionUtil" %>
    ...
    <div style="display: grid; grid-template-columns: 1fr 350px; gap: 30px; align-items: start;">
        ...
        <div style="position: sticky; top: 100px;">
            <div style="background: white; border-radius: 8px; border: 1px solid var(--border-color); padding: 20px;">
                ...
                <p style="font-size: 0.8rem; text-align: center; color: #64748b; margin-bottom: 20px;">By placing your order, you agree to FashionStore's privacy notice and conditions of use.</p>
