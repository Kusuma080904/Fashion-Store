        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <h2 class="logo">FASHIONSTORE</h2>
                    <p>Your one-stop destination for premium fashion, wardrobe essentials, and accessories.</p>
                </div>
                <div class="footer-col">
                    <h3>Quick Links</h3>
                    <ul>
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 Kusuma | FashionStore. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <div id="contactModal" class="modal-overlay" onclick="closeContactModal(event)">
        <div class="modal-content" style="max-width: 500px; text-align: left;" onclick="event.stopPropagation()">
            ...
            <div style="padding: 10px 0; font-size: 1.05rem;">
                <p style="margin-bottom: 15px;"><strong>Name:</strong> Kusuma N S</p>
                <p style="margin-bottom: 15px;"><strong>Phone:</strong> +91 6360171762</p>
                <p style="margin-bottom: 15px;"><strong>Email:</strong> <a href="mailto:kusumans690@gmail.com" style="color: var(--primary-color);">vikaskarthik7680@gmail.com</a></p>
            </div>
        ...
        <div class="modal-content" style="max-width: 600px; text-align: left;" onclick="event.stopPropagation()">
            ...
            <div style="padding: 10px 0; font-size: 1rem; color: #475569; max-height: 400px; overflow-y: auto;">
                <ul style="list-style-type: disc; padding-left: 20px; line-height: 1.8;">
                    ...
                    <li><strong>Damages:</strong> FashionStore is not liable for any products damaged or lost during shipping. If you received your order damaged, please contact the shipment carrier to file a claim.</li>
                </ul>
            </div>
            <div style="margin-top: 25px; text-align: right;">
