...
<head>
    ...
    <title>FashionStore - Style &amp; Trends</title>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/cart.js" defer></script>
    <script src="${pageContext.request.contextPath}/assets/js/product.js" defer></script>
